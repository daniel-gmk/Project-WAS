...
uniform int ScaleMultiplier : hint_range(2, 12) = 2;
...
void fragment() {
	...
	COLOR = vec4(mix(original_colour.rgb, ground_colour.rgb, original_colour.a), original_colour.a * destruction_map_colour.a);
}